...
# * click
# DEFAULT_CLICK_TIME = uniform(0.01, 0.05)  # * : float(in second) -> I don't use anymore
# DEFAULT_RECLICK_TIME = uniform(4, 5)  # * : float(in second) -> I don't use anymore
# DEFAULT_FAST_RECLICK_TIME = uniform(
#     0.3, 0.4
# )  # * : float(in second)
DEFAULT_INDEX = None
DEFAULT_X_OFFSET = 0
...
# * other
# CHECK_INTERVAL = uniform(0.003, 0.004)
DEFAULT_SCROLL_AMOUNT = 50
NUMBER_OF_ENERGY_REFILL = 4
TIME_BETWEEN_VOLUME_DECREASES = 300

# * fight
CHECK_BEFORE_AUTO_GVG_WORLD = 6
CHECK_BEFORE_AUTO_INTERSERVER = 8
