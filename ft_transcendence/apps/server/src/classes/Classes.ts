...
export class PongData {
  ...
  constructor(
    pongCanvasWidth = 1920,
    pongCanvasHeight = 1080,
    mode = 'normal',
    ballSpeedMultiplier = 1,
    player1SpeedMultiplier = 1,
    player2SpeedMultiplier = 1,
    player1SizeMultiplier = 1,
    player2SizeMultiplier = 1,
    colorBackground = '#252930',
    player1Color = 'FF14FB',
    player2Color = 'FF14FB',
    ballColor = 'FF14FB',
    scoreAndCenterLineColor = 'FF14FB',
    endScore = 11,
    defaultBallDirection = 1,
  ) {
    this._ballSpeed = ballSpeedMultiplier;
    this._pongCanvasWidth = pongCanvasWidth;
    this._pongCanvasHeight = pongCanvasHeight;
    this._mode = mode;
    this._playerDefaultProperties = new PlayerDefaultProperties(
      pongCanvasWidth,
      pongCanvasHeight,
      1,
    );
    this._ballProperties = new BallProperties(
      pongCanvasWidth,
      pongCanvasHeight,
      this._playerDefaultProperties._playerWidth,
      ballSpeedMultiplier,
      defaultBallDirection,
      0,
      this._mode,
    );
